...
public class AdminPlaceController {
    ...
    public ResponseEntity<?> createNewPlace(@Validated
                                            @RequestBody
                                            PlaceCreateDeleteDto createDto) {
        Long createPlaceId = null;
    ...
    public ResponseEntity<?> updatePlace(@Validated
        ...
        if (placeService.update(updateDto)) {
            return ResponseEntity.ok().body("{\"message\" : \"Update success!\"}");
        } else {
    ...
    public ResponseEntity<?> deletePlace(@Validated
                                         @RequestBody
                                         PlaceCreateDeleteDto deleteDto) {
        ...
        if (placeService.delete(forDeletePlace.get().placeId())) {
            return ResponseEntity.ok().body("{\"message\" : \"Remove successful!\"}");
        } else {
