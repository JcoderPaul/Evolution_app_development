...
public class ReservationService {
    ...
    public boolean update(ReservationUpdateDeleteDto reservationUpdate) {
        ...
        if (mayBeReservation.isEmpty()) {
            ...
            Reservation updatedReservation = reservationRepository.save(forUpdateReservation);

            boolean isDateUpdated = (updatedReservation.getReservationDate()).equals(reservationUpdate.reservationDate());
            boolean isPlaceIdUpdated = (updatedReservation.getPlace().getPlaceId()).equals(reservationUpdate.placeId());
            boolean isSlotIdUpdated = (updatedReservation.getSlot().getSlotId()).equals(reservationUpdate.slotId());

            return isDateUpdated & isPlaceIdUpdated & isSlotIdUpdated;
        } else {
    ...
    public Optional<List<ReservationReadDto>> findByUserId(Long userId) throws ReservationServiceException {
        Optional<List<Reservation>> mayBeAllReservationByUser = reservationRepository.findByUserId(userId);
    ...
    public Optional<List<ReservationReadDto>> findBySlotId(Long slotId) throws ReservationServiceException {
        Optional<List<Reservation>> mayBeAllReservationBySlot = reservationRepository.findBySlotId(slotId);
    ...
    public Optional<List<ReservationReadDto>> findByPlaceId(Long placeId) throws ReservationServiceException {
        Optional<List<Reservation>> mayBeAllReservationByPlace = reservationRepository.findByPlaceId(placeId);
    ...
    public Optional<List<ReservationReadDto>> findByDate(LocalDate date) throws ReservationServiceException {
        Optional<List<Reservation>> mayBeReservationsByDate = reservationRepository.findByDate(date);
    ...
    public Map<Long, List<Long>> findAllFreeSlotsByDate(LocalDate date) {
        ...
        Map<Long, List<ReservationReadDto>> reservationsByPlaceIdMap = reservationList.get()
                .stream()
